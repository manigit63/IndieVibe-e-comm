...
const Footer = () => {
  return (
    <footer className="bg-[#232F3E] text-white pt-10 mt-10 animate-fadeInUp">
      {/* Top Links Section */}
      ...
      {/* Contact Info */}
      <div className="max-w-7xl mx-auto px-6 py-6 text-sm text-gray-300 flex flex-col md:flex-row justify-between items-center gap-4">
        <div>
          <p>📧 Email: <a href="mailto:rajputprerna1503@gmail.com" className="text-blue-400 hover:underline">rajputprerna1503@gmail.com</a></p>
          <p>📞 Contact: <span className="text-blue-400">1234567890</span></p>
        </div>
        <div className="flex items-center gap-3 text-2xl">
          <i className="ri-shopping-bag-4-fill text-amber-500"></i>
          <span className="font-bold text-white text-lg">ShopNest</span>
        </div>
      </div>
